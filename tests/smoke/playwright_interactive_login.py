...
def run_login(account_info, headless=False):
...
def run_send_message(account_info, profile_path):
...
╚══════════════════════════════════════════════════════════════════╝
    ...
    # Probar login
    success, profile_path = run_login(account_info, headless=headless)
    ...
    if send_test != 'n':
        run_send_message(account_info, profile_path)
