...
def menu_deliver() -> None:
    ...
    while True:
        ...
        print(full_line())
        print("1) Crear licencia remota + archivo")
        print("2) Exportar archivo de licencia")
        print("3) Crear nueva licencia local")
        print("4) Ver todas las licencias")
        print("5) Eliminar o extender licencia")
        print("6) Generar ejecutable universal")
