...
def _patch_inbox_dependencies(
    ...
    *,
    ...
    monkeypatch.setattr(responder, "_send_lead_to_gohighlevel", lambda *_a, **_k: None)
    monkeypatch.setattr(responder, "_maybe_schedule_google_calendar_event", lambda *_a, **_k: None)
